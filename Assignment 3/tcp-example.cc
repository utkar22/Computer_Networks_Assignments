...
main (int argc, char *argv[])
{
  ...
  std::string bandwidth_n1n2 = "10Mbps";
  std::string delay_n1n2 = "100ms";
  ...
  pointToPoint.SetDeviceAttribute ("DataRate", StringValue (bandwidth_n0n1));
  pointToPoint.SetChannelAttribute ("Delay", StringValue (delay_n0n1));
  ...
  pointToPoint2.SetDeviceAttribute ("DataRate", StringValue (bandwidth_n1n2));
  pointToPoint2.SetChannelAttribute ("Delay", StringValue (delay_n1n2));
